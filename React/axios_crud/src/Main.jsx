...
import Add_Categoryaxios from './Pages/Add_Categoryaxios';
import Manage_Categoryaxios from './Pages/Manage_Categoryaxios';
  ...
  return (
    <div  id="wrapper">
      <Routes>
        ...
        <Route path="/add_Categoryaxios" element={<><Header/><Add_Categoryaxios/><Footer/></>} />
        <Route path="/manage_Categoryaxios" element={<><Header/><Manage_Categoryaxios/><Footer/></>} />
