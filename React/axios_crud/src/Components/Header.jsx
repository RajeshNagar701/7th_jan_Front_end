            ...
            <div className="navbar-default sidebar" role="navigation">
              <div className="sidebar-nav navbar-collapse">
                <ul className="nav" id="side-menu">
                  ...
                  <li>
                    <Link to="#" className=" hvr-bounce-to-right"><i className="fa fa-indent nav_icon" /> <span className="nav-label">Axios Category</span><span className="fa arrow" /></Link>
                    <ul className="nav nav-second-level">
                      <li><Link to="/add_Categoryaxios" className=" hvr-bounce-to-right"> <i className="fa fa-area-chart nav_icon" />Add Category</Link></li>
                      <li><Link to="/manage_Categoryaxios" className=" hvr-bounce-to-right"><i className="fa fa-map-marker nav_icon" />Manage Category</Link></li>
                    </ul>
                  </li>
